...
__asm__(
	...
	"	@ dump r3, too, to ensure 8-byte EABI alignment\n"
	"	stmdb	sp!, {r0-r3}\n"
	"	@ enter DL_START\n"
	"	bl	_dl_start\n"
	"	@ returns user entry point in r0\n"
	"	mov	r6, r0\n"
	"	@ restore arguments for libmain and friends and remove pad\n"
	"	ldmia	sp!, {r0-r3}\n"
...
__asm__(
	...
	"	@ is thumb)\n"
	"	@ NB: FOR HiStar, DON'T CLOBBER R0-R2!!\n"
	"	adr	r3, __dl_thumb_start+1\n"
	"	bx	r3\n"
	"\n\n"
    "	.thumb\n"
