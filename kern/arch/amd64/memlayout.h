...
#define USTACKBASE	UINT64 (0x00003fff00000000)
...
// These constants are used in the kernel for fault handling
#define UTRAPHANDLER	UINT64 (0x0000500000000000)
#define UTRAPSTACK	UINT64 (0x0000500008000000)
#define UTRAPSTACKTOP	UINT64 (0x0000500010000000)
