...
#KERN_BINFILES	+= user/captest user/capburn user/capfluct user/capsleep
#KERN_BINFILES	+= user/capbal #user/maps user/map.png
#KERN_BINFILES	+= user/libpng12.so.0
#KERN_BINFILES	+= user/capgraph user/capwrap user/spin
#KERN_BINFILES	+= user/capperf
#KERN_BINFILES	+= user/libjpeg.so.7
#KERN_BINFILES	+= user/terminfo.tar.gz
#KERN_BINFILES	+= user/fetchmail
#KERN_BINFILES	+= user/cachesrv user/cacheclnt
#KERN_BINFILES	+= user/netcat
...
#KERN_BINFILES	+= user/ssh user/scp
...
#KERN_BINFILES	+= user/libxkbfile.so.1 user/libXm.so.2 user/xorg.conf
#KERN_BINFILES	+= user/urxvt user/xpdf
#KERN_BINFILES	+= user/Xorg
