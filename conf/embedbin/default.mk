...
KERN_BINFILES	+= user/ls user/asprint user/gl user/jcat user/cat user/rm user/cp user/echo user/mount user/umount user/sync user/mkdir user/reboot user/ureboot user/jenv
